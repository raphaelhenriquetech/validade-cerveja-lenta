...
const Auth = () => {
  ...
  return <div className="flex min-h-screen w-full font-display">
      ...
      <div className="relative hidden w-2/5 flex-col items-center justify-center bg-[#101622] text-primary-foreground lg:flex">
        ...
        <div className="absolute inset-0 z-0">
          <svg height="100%" width="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern height="48" id="grid-pattern" patternTransform="scale(1) rotate(0)" patternUnits="userSpaceOnUse" width="48">
                <rect fill="hsla(0,0%,100%,0)" height="100%" width="100%" x="0" y="0" />
                <path d="M12 16H0v-4h12V0h4v12h12v4H16v12h-4V16zm12 20H12v-4h12V20h4v12h12v4H28v12h-4V36zM36 0v4h12v12h4V4h-4V0h-8z" fill="hsla(223, 75%, 25%, 0.1)" stroke="none" strokeWidth="1" />
              </pattern>
            </defs>
        ...
        <div className="relative z-10 flex flex-col items-center px-16 max-w-lg w-full">
          <div className="flex items-center justify-center pb-6 w-full">
            <img src={stockbrewLogo} alt="StockBrew" className="h-28 w-auto" />
          </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-[#f6f6f8] dark:bg-background p-4 sm:p-6 lg:p-8 relative">
        ...
        <div className="flex w-full max-w-md flex-col items-start gap-2">
          ...
          <div className="flex items-center justify-center pb-4 lg:hidden w-full">
            <img src={stockbrewLogo} alt="StockBrew" className="h-20 w-auto" />
          </div>
          ...
          <p className="text-muted-foreground text-base font-normal leading-normal pb-6">
            {isLogin ? 'Bem-vindo de volta! Por favor, insira seus dados.' : 'Preencha os dados abaixo para criar sua conta.'}
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex w-full flex-col gap-5">
            ...
            <label className="flex flex-col w-full">
              ...
              <div className="relative flex items-center">
                ...
                <Input type="email" placeholder="Digite seu email" value={email} onChange={e => setEmail(e.target.value)} className="h-14 pl-12 pr-4 text-base bg-background border-border focus:ring-2 focus:ring-primary/50" required />
              </div>
            </label>
            ...
            <label className="flex flex-col w-full">
              ...
              <div className="relative flex items-center">
                ...
                <Input type={showPassword ? 'text' : 'password'} placeholder="Digite sua senha" value={password} onChange={e => setPassword(e.target.value)} className="h-14 pl-12 pr-12 text-base bg-background border-border focus:ring-2 focus:ring-primary/50" required />
            ...
            {isLogin && <div className="flex w-full items-center justify-end -mt-2">
                <button type="button" className="text-primary text-sm font-medium leading-normal underline hover:text-primary/80 transition-colors" onClick={() => toast({
              title: 'Em breve',
            ...
            {/* Submit Button */}
            <Button type="submit" className="w-full h-14 text-base font-bold mt-2" disabled={submitting}>
