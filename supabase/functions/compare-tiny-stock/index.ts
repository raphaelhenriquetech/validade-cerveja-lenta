  ...
  try {
    ...
    for (const sku of skus) {
      try {
        ...
        const searchResponse = await fetch('https://api.tiny.com.br/api2/produtos.pesquisa.php', {
          method: 'POST',
          body: searchFormData,
        });
        ...
        const stockResponse = await fetch('https://api.tiny.com.br/api2/produto.obter.estoque.php', {
          method: 'POST',
          body: stockFormData,
        });
